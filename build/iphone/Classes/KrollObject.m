...
//@interface TiShadowObject : NSObject
//@end

@interface TiShadowObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TiShadowObject class]])
		{
			for (NSString *key in [[(TiShadowObject*)o modules] allKeys])
			{
