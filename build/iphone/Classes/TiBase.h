...
// in simulator we redefine to format for TiShadow Developer console
...
{\
	NSString * exceptionName = [@"org.tishadow." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tishadow";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITiShadowNativeItemNone = -1, 
	UITiShadowNativeItemSpinner = -2,
	UITiShadowNativeItemProgressBar = -3,
	
	UITiShadowNativeItemSlider = -4,
	UITiShadowNativeItemSwitch = -5,
	UITiShadowNativeItemMultiButton = -6,
	UITiShadowNativeItemSegmented = -7,
	
	UITiShadowNativeItemTextView = -8,
	UITiShadowNativeItemTextField = -9,
	UITiShadowNativeItemSearchBar = -10,
	
	UITiShadowNativeItemPicker = -11,
	UITiShadowNativeItemDatePicker = -12,
	
	UITiShadowNativeItemInfoLight = -13,
	UITiShadowNativeItemInfoDark = -14,
	
	UITiShadowNativeItemDisclosure = -15,
	
	UITiShadowNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TiShadow instances of
