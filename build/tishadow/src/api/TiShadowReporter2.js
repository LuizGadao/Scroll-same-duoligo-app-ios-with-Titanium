...
var TiShadowReporter2 = function(options) {
    var log = options.log, colorize = !!options.showColors ? markColor : ignoreColor, onComplete = options.onComplete || function() {}, timer = options.timer || noopTimer, specCount, failureCount, failedSpecs, pendingCount, level, currentSuiteId, ansi = {
        green: "[32m",
        red: "[31m",
        yellow: "[33m",
        none: "[0m"
    ...
    this.jasmineDone = function() {
        ...
        printNewline();
        var specCounts = specCount + " " + pluralize("spec", specCount) + ", " + failureCount + " " + pluralize("failure", failureCount);
        if (pendingCount) {
