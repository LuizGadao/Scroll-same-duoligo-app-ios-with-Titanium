...
function loadFile() {
    lookup = {};
    var file = Ti.Filesystem.getFile(__p.file(Ti.Filesystem.applicationDataDirectory + TiShadow.currentApp + "/" + exports.locale + "/strings.xml"));
    if (!file.exists()) {
        file = Ti.Filesystem.getFile(__p.file(Ti.Filesystem.applicationDataDirectory + TiShadow.currentApp + "/en/strings.xml"));
        if (!file.exists()) {
