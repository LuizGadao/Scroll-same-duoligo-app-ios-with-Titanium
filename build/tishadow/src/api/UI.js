...
function prepareArgs(a) {
    var container = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function(c) {
        var r = Math.random() * 16 | 0, v = c == "x" ? r : r & 3 | 8;
        return v.toString(16);
    });
    var app = __p.require("/api/TiShadow").currentApp || "__REPL";
    var args = a || {};
...
var create = function(fn, a) {
    ...
    o.addEventListener("close", function(e) {
        unstack({
            app: args.__tishadowApp,
            container: args.__tishadowContainer
        });
    });
    return o;
};
