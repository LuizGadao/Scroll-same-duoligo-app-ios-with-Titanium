(function(define) {
    ...
    (typeof define === "function" && define.amd && function(m) {
        ...
        module.exports = m(__p.require("samsam"));
    } || function(m) {
    ...
    var sinon = function(formatio) {
        ...
        if (isAMD) {
            ...
            if (!formatio) {
                try {
                    formatio = __p.require("formatio");
                } catch (e) {}
                module.exports.spy = __p.require("lib/sinon/spy");
                module.exports.spyCall = __p.require("lib/sinon/call");
                module.exports.behavior = __p.require("lib/sinon/behavior");
                module.exports.stub = __p.require("lib/sinon/stub");
                module.exports.mock = __p.require("lib/sinon/mock");
                module.exports.collection = __p.require("lib/sinon/collection");
                module.exports.assert = __p.require("lib/sinon/assert");
                module.exports.sandbox = __p.require("lib/sinon/sandbox");
                module.exports.test = __p.require("lib/sinon/test");
                module.exports.testCase = __p.require("lib/sinon/test_case");
                module.exports.assert = __p.require("lib/sinon/assert");
                module.exports.match = __p.require("lib/sinon/match");
            }
        }
        if (formatio) {
    ...
    (function(sinon) {
        ...
        if (!sinon && commonJSModule) {
            sinon = __p.require("sinon");
            sinon.extend(sinon, __p.require("lib/util/fake_timers"));
        }
        var push = [].push;
    ...
    return sinon;
}).call(typeof window != "undefined" && window || {}, typeof define !== "undefined" && define || {});